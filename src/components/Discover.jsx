...
// const ProductMarquee = ({currentCategory}) => {
...
const ProductCard = ({ product }) => {
    ...
    return (
        <div className="flex-shrink-0 w-64 mx-6 group cursor-pointer" onClick={() => window.open(`/product/${product.id}`)}>
            <div className="aspect-[3/4] overflow-hidden bg-[#fafafa] relative border border-gray-50">
                <img
                    src={displayImage}
                    alt={product.name}
            ...
            <div className="relative w-full overflow-hidden group space-y-8">
                ...
                {loading ? (
                    ...
                    <>
                        ...
                        <div className="flex animate-marquee-reverse hover:[animation-play-state:paused] py-2">
