...
export default function Register() {
    ...
    const handleRegister = async (e) => {
        ...
        try {
            ...
            toast.success('Welcome to Sasha Store!', { position: "bottom-center", theme: "light" });
    ...
    const handleGoogleSignUp = async () => {
        ...
        try {
            ...
            toast.success('Account created successfully!', { position: "bottom-center", theme: "light" });
            setTimeout(() => navigate('/cart'), 1500);
        } catch (err) {
    ...
    return (
        <div className="min-h-screen bg-[#fafafa] flex items-center justify-center px-4">
            <ToastContainer />
            <div className="w-full max-w-[480px] bg-white p-8 md:p-12 shadow-[0_4px_25px_rgba(0,0,0,0.05)] rounded-sm">
                
                {/* Brand Header */}
                <div className="text-center mb-10">
                    <h2 className="text-3xl font-light tracking-widest uppercase text-gray-900 mb-2">Register</h2>
                    <div className="h-[1px] w-12 bg-gray-400 mx-auto mb-6"></div>
                    <p className="text-gray-500 text-sm font-light">Join the Sasha Store community</p>
                </div>

                {error && (
                    <div className="mb-6 text-center text-[11px] tracking-widest text-red-500 uppercase border-b border-red-500 pb-2">
                        {error}
                    </div>
                )}
                ...
                <form onSubmit={handleRegister} className="space-y-6">
                    <div>
                        <input
                            className="w-full border-b border-gray-200 py-3 px-1 text-sm outline-none focus:border-gray-900 transition-colors bg-transparent placeholder:text-gray-300 font-light"
                            type="text"
                    ...
                    <p className="text-[11px] text-gray-400 font-light leading-relaxed">
                        By creating an account, you agree to our <span className="underline cursor-pointer">Terms & Conditions</span> and <span className="underline cursor-pointer">Privacy Policy</span>.
                    </p>

                    <button
                        className="w-full bg-gray-900 hover:bg-black text-white text-xs font-medium tracking-[0.2em] uppercase py-4 transition-all duration-300 mt-4 disabled:bg-gray-400"
                        type="submit"
                        disabled={loading || googleLoading}
                    >
                        {loading ? 'Creating Account...' : 'Create Account'}
                    ...
                    <div className="relative flex items-center py-2">
                        ...
                        <span className="flex-shrink mx-4 text-[10px] tracking-widest text-gray-400 uppercase">Or</span>
                        <div className="flex-grow border-t border-gray-100"></div>
                    </div>
                    ...
                    <button
                        ...
                        onClick={handleGoogleSignUp}
                        disabled={loading || googleLoading}
                        className="w-full border border-gray-200 hover:border-gray-900 text-gray-700 text-[11px] font-medium tracking-[0.15em] uppercase py-3 flex items-center justify-center transition-all duration-300 disabled:opacity-50"
                    >
                ...
                <div className="mt-12 text-center border-t border-gray-50">
                    <p className="text-gray-500 text-[12px] font-light tracking-wide">
                        Already have an account?
                        <button
                            type="button"
                            className="ml-2 text-gray-900 font-normal underline underline-offset-4 hover:text-gray-600 uppercase text-[11px]"
                            onClick={() => navigate('/login')}
                        >
                            Log In
                        </button>
